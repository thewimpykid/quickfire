  ...
  return (
    <div className="bg-black">
      <main className="w-full flex min-h-screen flex-col items-center justify-center p-6 text-orange-400">
        <h1 className="text-base text-white bg-opacity-50 bg-black p-4 mb-8 opacity-40 z-40">
        ...
        <h1 className="text-8xl font-bold text-gray-700 bg-opacity-50 mb-12 z-40">
          quickfire
        </h1>

        <div className="w-full flex justify-center gap-4 mb-4 z-40">
          <select
            value={subject}
            onChange={handleSubjectChange}
            className="bg-gray-800 text-white outline-none w-60 px-4 py-2 h-12 rounded-sm hover:bg-gray-700 transition-colors"
          >
          ...
          {subject && (
            <select
              ...
              className="bg-gray-800 text-white outline-none w-60 px-4 py-2 h-12 rounded-sm hover:bg-gray-700 transition-colors mb-2"
            >
          ...
          <select
            ...
            className="bg-gray-800 text-white outline-none w-40 px-4 py-2 h-12 rounded-sm hover:bg-gray-700 transition-colors"
          >
        ...
        <div className="flex justify-center items-center">
          <div className="flex items-center mb-4">
            <button
              ...
              className="w-60 bg-cyan-600 text-white py-2 rounded-lg hover:bg-cyan-500 transition-colors mt-4 h-12 mr-6"
            >
              Generate Problem
            </button>
            <div className="flex justify-center items-center">
              <p className="text-white mt-4 text-4xl">🔥{streak}</p>
            </div>
          </div>
        </div>
        ...
        <div className={`w-full max-w-lg px-6 py-4 rounded-lg shadow-lg mt-4 ${problem ? 'bg-gray-900' : ''}`}>
          {problem && (
            <div className="w-full mb-4 p-4 rounded-md">
              <h2 className="text-xl font-semibold mb-6 text-white">{problem}</h2>
              <ul className="mt-2">
              ...
              <div className="flex justify-center items-center">
                <button
                  onClick={generateProblem}
                  className="w-60 bg-cyan-600 text-white py-2 rounded-lg hover:bg-cyan-500 transition-colors mt-6 mb-4 h-12 mx-8"
                >
                  Next
                </button>
              </div>
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="w-180 text-cyan-500 hover:text-cyan-400 py-2 rounded-lg transition-colors h-4 mx-8"
                >
        ...
        <h1 className="text-base text-white bg-opacity-50 bg-black p-4 opacity-40 z-40 mt-8">
